<?php
// actions/artist/update_profile.php
session_start();
...
try {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
        ...
        $image_path = 'assets/images/profiles/' . $filename;
        ...
        $stmt = $conn->prepare("SELECT profile_image_url FROM artists WHERE user_id = ?");
    ...
    $params = [$_POST['name'], $_POST['bio'], $_POST['phone']];
    if ($image_path) {
        $params[] = $image_path;
    }
    ...
    header("Location: ../../views/artist/profile.php");
    exit();
